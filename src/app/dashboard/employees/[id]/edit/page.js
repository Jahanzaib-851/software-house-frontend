...
export default function EditEmployeePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Agar nayi image select ki hai toh hi bhejni hai
    if (formData.avatar) {
  ...
  if (fetching) return <div className="p-20 text-center animate-pulse font-black text-slate-300">LOADING DATA...</div>;
    ...
    <div className="min-h-screen bg-[#F8FAFC] p-6 lg:p-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-slate-50">
          <h1 className="text-3xl font-black text-slate-900 mb-8 text-center">Update Profile</h1>
